        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="col-md-4">
                        <div class="card">
                            <img class="card-img-top card-image" src="{{ asset('images/user.png') }}" width="40px" height="90px" alt="User Image">
                            <div class="card-body">
                                <h5 class="card-title" style="color: #1f8af5">{{ $visitor->name ?? 'Not Available' }}</h5>
                                <p class="card-text">{{ $visitor->user_details->gender ?? 'Not Available' }}</p>
                            </div>
                            <ul class="list-group list-group-flush">
                                {{--                    <li class="list-group-item">Visits: {{ $visitor->visits->count() ?? '0' }}</li>--}}
                                <li class="list-group-item">Visits: {{ $visitorCount?? '0' }}</li>
                            </ul>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            @foreach($visitor as $visit)
                                <tr>
                                    <td>@if($visitor)
                                            <p>Created at: {{ $visitor->created_at->format('d-m-Y') }}</p>
                                        @endif</td>
