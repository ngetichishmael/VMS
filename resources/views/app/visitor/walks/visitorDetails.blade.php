...
@section('content')
    ...
    <div class="container" style="font-size: small">
        <div class="pl-3 row">
            <div class="destination-card">
                <div class="destination-card-left">
                    <div class="card">
                        ...
                        {{--                    </div> --}}
                        <div class="pl-2 image-container" style="width: 200px; height: 150px">
                            @if ($visitor->user_details->image)
                                <img src="{{ asset('storage/attachments/' . $visitor->user_details->image) }}"
                                    alt="{{ $visitor->name }}'s ID picture" width="50" height="40" />
                            @else
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ $visitor->Resident->unit->block->name ?? 'Not Available' }}" readonly />
                            </div>
                        </div>
                        <div class="col-md-10">
                            <div class="form-group">
                    ...
                    <div class="visitor-info">
                        ...
                        <div class="mb-1 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ $visitor->user_details->ID_number ?? 'Not Available' }}" readonly>
                            </div>
                        </div>
                        <div class="pl-1 mb-1 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ $visitor->user_details->date_of_birth ?? 'Not Available' }}" readonly>
                            </div>
                        </div>
                        <div class="pl-1 mb-1 col-md-4">
                            <div class="form-group">
                        ...
                        <div class="pl-1 mb-1 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ $visitor->user_details->secondary_phone_number ?? 'Not Available' }}"
                                    readonly />
                            </div>
                        </div>
                        <div class="pl-1 mb-1 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ $lastTimeLog->entry_time ?? 'Visitor Still in' }}" readonly />
                            </div>
                        </div>
                        <div class="pl-1 mb-1 col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="pl-1 mb-1 col-md-12">
                                        <div class="form-group">
                                            <label>Duration</label>
                                            <input type="text" class="form-control" value="{!! Carbon::parse($visitor->timeLog->entry_time ?? now())->diff(Carbon::parse($visitor->timeLog->exit_time ?? now()))->format('%H Hours %I Minutes %S Seconds') !!} "
                                                readonly />
                                        </div>
            ...
            @if (
                $visitor->attachment1 != null ||
                    $visitor->attachment2 != null ||
                    $visitor->attachment3 != null ||
            ...
            <div class="mt-2 col-12 d-flex flex-sm-row flex-column" style="gap: 20px;">
                <a href="{{ route('VisitDriveIn') }}" type="reset"
                    style="margin-left: 85%;background: #54a4f3; color: #ffffff" class="btn btn-btn-secondary"> Back </a>
            </div>
        </div>
    </div>
    </div>
