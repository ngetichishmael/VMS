    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST"
                        action="{{ route('OrganizationSetting.update', ['setting' => $organization_code->id]) }}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-12">
                                                ...
                                                <div class="col-12">
                                                    <div class="mt-1 border rounded table-responsive">
                                                        <h6 class="py-1 mx-1 mb-0 font-medium-2">
                                                            ...
                                                            <span class="align-middle">Setting on
                                                                <strong>{!! $organization_code->organization->name !!} </strong>
                                                                <strong>{!! $organization_code->organization->name !!} </strong> subscriptions
                                                            </span>
                                                        </h6>
                                                            ...
                                                            <tbody>
                                                                    ...
                                                                    <td>
                                                                        <div class="custom-control custom-checkbox">
                                                                            <input type="checkbox"
                                                                                ...
                                                                                name="id_checkin" {{--                                               @if ($permissions->van_sales === 'YES') checked @endif --}} />
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="custom-control custom-checkbox">
                                                                            <input type="checkbox"
                                                                                class="custom-control-input" id="staff-read"
                                                                                name="ipass_checkin"
