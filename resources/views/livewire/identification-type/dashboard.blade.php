...
@section('title', 'Identification Types')
...
@section('content')
    ...
    <section id="dashboard-ecommerce">
        ...
        <h2 class="brand-text">TODO ON IDENTIFICATION TYPES</h2>
        <div class="card-body">
            <div id="jstree-basic">
                <ul>
                    ...
                    <li class="jstree-open" data-jstree='{"icon" : "far fa-folder"}'>
                        Examples
                        <ul>
                            <li data-jstree='{"icon" : "fab fa-css3-alt"}'>ID</li>
                            <li data-jstree='{"icon" : "fab fa-css3-alt"}'>Passport</li>
                            <li data-jstree='{"icon" : "fab fa-css3-alt"}'>Police Abstract</li>
                            <li data-jstree='{"icon" : "fab fa-css3-alt"}'>Foreign ID</li>
                            <li data-jstree='{"icon" : "fab fa-css3-alt"}'>Huduma Number</li>
                            <li data-jstree='{"icon" : "fab fa-css3-alt"}'>OTP Via Number</li>
                            <li data-jstree='{"icon" : "fab fa-css3-alt"}'>QRCode</li>
                        </ul>
                    </li>
                    <li class="jstree-open" data-jstree='{"icon" : "far fa-folder"}'>
                        Table
