                            ...
                            @forelse ($users as $key => $user)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a wire:ignore.self href="#" wire:click="activate({{ $user->id }})" onclick="return confirmOrCancel('Are you sure you want to activate the user?')" style="padding-right:20px;">Activate</a>
                                        <?php }else{ ?>
